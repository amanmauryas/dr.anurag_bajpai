...
export default function BMICalculator() {
  ...
  const calculateBMI = (e: React.FormEvent) => {
    ...
    // Approximate pediatric BMI categories based on age and sex (CDC percentiles simplified)
    // 50th percentile BMI is roughly 16 for age 8. Obese (95th) is roughly 20+ for age 8.
    ...
    let advice = "Your child's BMI is in the healthy range. Continue to provide a balanced diet, encourage 60 minutes of active play daily, and ensure regular sleep patterns.";

    // Threshold values change with age. Let's create an approximate model.
    // For general simplicity, we map out 5th, 85th, 95th percentiles dynamically:
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 p-6 md:p-8 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-xl font-bold text-gray-900 dark:text-white">Pediatric BMI Calculator</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">For children and adolescents aged 2 to 19 years</p>
        </div>
      </div>
